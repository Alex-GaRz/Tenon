...
| RFC-06 | Discrepancy Taxonomy | PASS | PR #12 → release/v1-tenon | <7619835> | pytest tests_systemic/ -k "rfc06" (24 PASS) | Taxonomy v1 closed. WORM compliance. |
| RFC-07 | Causality Model | PASS | PR #12 → release/v1-tenon | <7619835> | pytest tests_systemic/ -k "rfc07" (24 PASS) | Causality v1 con preservación de ambigüedad. |
...
| RFC-13 | Risk Observability | PASS | PR #13 → release/v1-tenon | <5e6a442> | pytest tests_systemic/ -k "rfc13" (40 PASS) | Risk v1 anti-vanity. Determinismo vía SHA-256. |
