...
Cualquier modificación al RFC-00 **solo puede realizarse mediante un RFC de enmienda** (RFC-00A_*) que siga el protocolo definido en [`docs/governance/RFC_Amendment_Policy.md`](../governance/RFC_Amendment_Policy.md).

**Cambios directos al RFC-00 sin protocolo de enmienda están prohibidos y deben ser bloqueados por CI.**

---

## RFCs Adicionales

Los RFCs numerados (RFC-01, RFC-02, etc.) extienden y especifican aspectos técnicos del sistema, pero todos deben respetar los invariantes y no-goals establecidos en RFC-00.
